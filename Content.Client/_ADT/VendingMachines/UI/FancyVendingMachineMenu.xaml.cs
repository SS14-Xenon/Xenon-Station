...
public sealed partial class FancyVendingMachineMenu : FancyWindow
{
    ...
    private void PopulateList()
    {
        ...
        foreach (var item in _cachedItems.Where(d => DataFilterCondition(SearchBar.Text, d)))
        {
            ...
            if (item.Entry.Type == InventoryType.Emagged)
            {
                listItem.SetColoring(EmaggedButtonBaseColor, EmaggedButtonBorderColor, EmaggedButtonHoveredColor, EmaggedButtonDisabledColor);
            }
            else
            {
