...
namespace Content.Client.Chemistry.UI
{
    ...
    public sealed partial class ChemMasterWindow : FancyWindow
    {
        ...
        private void UpdatePanelInfo(ChemMasterBoundUserInterfaceState state)
        {
            ...
            var reagentList = new List<(ReagentId reagentId, string name, Color color, FixedPoint2 quantity, float ph)>();
            foreach (var (reagent, quantity) in state.BufferReagents)
            {
                ...
                reagentList.Add(new (reagentId, name, reagentColor, quantity, proto?.PH ?? ChemistryPH.NeutralPH));
            }
            ...
            {
                BufferInfo.Children.Add(BuildReagentRow(reagent.color, rowCount++, reagent.name, reagent.reagentId, reagent.quantity, true, true, reagent.ph));
            }
        }
        ...
        private void BuildContainerUI(Control control, ContainerInfo? info, bool addReagentButtons)
        {
            ...
            if (info.Reagents != null)
            {
                foreach (var reagent in info.Reagents)
                {
                    ...
                    var name = proto?.LocalizedName ?? Loc.GetString("chem-master-window-unknown-reagent-text");
                    var reagentColor = proto?.SubstanceColor ?? default(Color);
                    var reagentPh = proto?.PH ?? ChemistryPH.NeutralPH;

                    control.Children.Add(BuildReagentRow(reagentColor, rowCount++, name, reagent.Reagent, reagent.Quantity, false, addReagentButtons, reagentPh));
                }
            }
        }
        /// <summary>
        ...
        /// </summary>
        private Control BuildReagentRow(Color reagentColor, int rowCount, string name, ReagentId reagent, FixedPoint2 quantity, bool isBuffer, bool addReagentButtons, float? ph = null)
        {
            ...
            var quantityText = ph is { } reagentPh
                ? Loc.GetString("chem-master-window-quantity-with-ph-label-text", ("quantity", quantity), ("ph", reagentPh.ToString("0.0")))
                : Loc.GetString("chem-master-window-quantity-label-text", ("quantity", quantity));
